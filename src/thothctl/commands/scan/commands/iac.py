...
click.option(
    ...
    '-t',
    multiple=True,
    type=click.Choice(['trivy', 'tfsec', 'checkov', 'terraform-compliance'], case_sensitive=False),
...
click.option(
    '--trivy-options',
    help='Additional options for Trivy scanner'
),
click.option(
    '--tfsec-options',
    help='Additional options for TFSec scanner'
),
click.option(
    '--checkov-options',
    help='Additional options for Checkov scanner'
),
click.option(
