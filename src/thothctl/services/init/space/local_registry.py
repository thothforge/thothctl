...
class TerraformModuleVersions:
    ...
    def get_cache_filename(self, namespace: str, type: str = "module", name: str = "", provider: str = "") -> str:
    ...
    def get_metadata_filename(self, namespace: str, type: str = "module", name: str = "", provider: str = "") -> str:
    ...
    def is_cache_valid(self, namespace: str, type: str = "module", name: str = "", provider: str = "") -> bool:
        try:
    ...
    def save_to_cache(self, data: Dict, namespace: str, type: str = "module", name: str = "", provider: str = ""):
        try:
            ...
            if type == "module":
                metadata.update({
                    'name': name,
                    'provider': provider,
                    'version_count': len(data['modules'][0]['versions']) if data.get('modules') else 0
                })
            else:
    ...
    def load_from_cache(self, namespace: str, type: str = "module", name: str = "", provider: str = "") -> Optional[
        Dict]:
        try:
            cache_file = self.get_cache_filename(namespace, type, name, provider)
    ...
    def fetch_module_versions(self, namespace: str, name: str, provider: str, limit: int = 3) -> Optional[Dict]:
    ...
    def get_namespace_modules(self, namespace: str, force_refresh: bool = False) -> Optional[Dict]:
    ...
    def get_module_versions(self, namespace: str, name: str, provider: str,
                            force_refresh: bool = False, limit: int = 3) -> Optional[Dict]:
        """Get module versions from cache or fetch if needed"""
        if not force_refresh and self.is_cache_valid(namespace, "module", name, provider):
