...
class ScannerPort(ABC):
    ...
    @abstractmethod
    def scan(self, directory: str, reports_dir: str, options: Optional[Dict] = None, tftool:str= "tofu") -> Dict[str, str]:
...
class Scanner:
    ...
    def execute_scan(self, directory: str, reports_dir: str, options: Optional[Dict] = None, tftool:str= "tofu") -> Dict[str, str]:
...
class ScanOrchestrator:
    ...
    def run_scans(self, directory: str, reports_dir: str, options: Dict[str, Dict], tftool:str= "tofu") -> Dict[str, str]:
        results = {}
        for scanner in self.scanners:
            scanner_options = options.get(scanner.name, {})
            try:
                result = scanner.execute_scan(directory, reports_dir, scanner_options, tftool)
