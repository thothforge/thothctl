...
class ELBPricingProvider(BasePricingProvider):
    ...
    def calculate_cost(
        ...
        try:
            ...
            product_family = product_family_map.get(
                load_balancer_type, "Load Balancer-Application"
            )
            ...
            if products:
                ...
                return self._create_resource_cost(
                    resource_change, load_balancer_type, region, hourly_cost, "high"
                )
    ...
    def get_offline_estimate(
        ...
        return self._create_resource_cost(
            resource_change, load_balancer_type, region, hourly_cost, "medium"
        )
