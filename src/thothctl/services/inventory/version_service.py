...
class VersionChecker:
    ...
    async def _build_source_url(self, resource: str) -> str:
        ...
        base_url = self.REGISTRY_URLS.get(registry_type, self.REGISTRY_URLS[RegistryType.TERRAFORM])
...
# Usage example
async def main():
    inventory = {"version": 2, "projectName": "terraform_aws_eks_pattern", "components": [
        {"path": "./resources/databases/elasticache_redis", "components": [
            {"type": "module", "name": "secrets_manager_default", "version": ["1.1.2"],
             "source": ["terraform-aws-modules/secrets-manager/aws"],
             "file": "./resources/databases/elasticache_redis/main.tf", "latest_version": "1.3.1",
             "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/secrets-manager/aws",
             "status": "Outdated"}, {"type": "module", "name": "secrets_manager_buc", "version": ["1.1.2"],
                                     "source": ["terraform-aws-modules/secrets-manager/aws"],
                                     "file": "./resources/databases/elasticache_redis/main.tf",
                                     "latest_version": "1.3.1",
                                     "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/secrets-manager/aws",
                                     "status": "Outdated"},
            {"type": "module", "name": "elasticache_user_group", "version": ["1.2.0"],
             "source": ["terraform-aws-modules/elasticache/aws//modules/user-group"],
             "file": "./resources/databases/elasticache_redis/main.tf", "latest_version": "1.4.1",
             "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/elasticache/aws",
             "status": "Outdated"}, {"type": "module", "name": "elasticache", "version": ["1.2.0"],
                                     "source": ["terraform-aws-modules/elasticache/aws"],
                                     "file": "./resources/databases/elasticache_redis/main.tf",
                                     "latest_version": "1.4.1",
                                     "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/elasticache/aws",
                                     "status": "Outdated"}]}, {"path": "./resources/operations", "components": [
            {"type": "module", "name": "project_resources", "version": "Null",
             "source": ["../../modules/terraform-aws-resource-groups"], "file": "./resources/operations/main.tf",
             "latest_version": "Null", "source_url": "Null", "status": "Null"}]},
        {"path": "./resources/security/cognito", "components": [
            {"type": "module", "name": "cognito", "version": "Null",
             "source": ["../../../modules/terraform-aws-cognito-user-pool"],
             "file": "./resources/security/cognito/main.tf", "latest_version": "Null", "source_url": "Null",
             "status": "Null"}]}, {"path": "./resources/security/kms/infrastructure", "components": [
            {"type": "module", "name": "kms", "version": ["3.0.0"], "source": ["terraform-aws-modules/kms/aws"],
             "file": "./resources/security/kms/infrastructure/main.tf", "latest_version": "3.1.1",
             "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/kms/aws",
             "status": "Outdated"}, {"type": "module", "name": "parameter_store", "version": ["0.13.0"],
                                     ...
                                     "status": "Updated"}]},
        {"path": "./resources/security/secretsmanager/custom_app_secrets", "components": [
            {"type": "module", "name": "secrets_manager_buc", "version": ["1.1.2"],
             "source": ["terraform-aws-modules/secrets-manager/aws"],
             "file": "./resources/security/secretsmanager/custom_app_secrets/main.tf", "latest_version": "1.3.1",
             "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/secrets-manager/aws",
             "status": "Outdated"}]}, {"path": "./resources/security/iam/instance_profile/ec2_bastion",
                                       "components": [
                                           {"type": "module", "name": "asg_instance_profile", "version": "Null",
                                            "source": ["../../../../../modules/aws-ec2-instance-profile"],
                                            "file": "./resources/security/iam/instance_profile/ec2_bastion/main.tf",
                                            "latest_version": "Null", "source_url": "Null", "status": "Null"}]},
        {"path": "./resources/security/iam/iam_service_accounts", "components": [
            {"type": "module", "name": "iam_eks_role", "version": ["5.39.1"],
             "source": ["terraform-aws-modules/iam/aws//modules/iam-role-for-service-accounts-eks"],
             "file": "./resources/security/iam/iam_service_accounts/main.tf", "latest_version": "5.52.2",
             "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/iam/aws",
             "status": "Outdated"}]}, {"path": "./resources/security/iam/policies/iam_service_account_policies",
                                       "components": [
                                           {"type": "module", "name": "iam_policy", "version": ["5.39.1"],
                                            "source": ["terraform-aws-modules/iam/aws//modules/iam-policy"],
                                            "file": "./resources/security/iam/policies/iam_service_account_policies/main.tf",
                                            "latest_version": "5.52.2",
                                            "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/iam/aws",
                                            "status": "Outdated"}]}, {"path": "./resources/compute/ec2/ec2_bastion",
                                                                      "components": [
                                                                          {"type": "module", "name": "ec2",
                                                                           "version": ["5.6.1"], "source": [
                                                                           ...
                                                                           "status": "Outdated"}, {"type": "module",
                                                                                                   ...
                                                                                                   "source_url": "Null",
                                                                                                   "status": "Null"}]},
        {"path": "./resources/compute/key_pairs", "components": [
            {"type": "module", "name": "key_pair", "version": ["2.0.3"],
             "source": ["terraform-aws-modules/key-pair/aws"], "file": "./resources/compute/key_pairs/main.tf",
             "latest_version": "2.0.3",
             "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/key-pair/aws",
             "status": "Updated"}, {"type": "module", "name": "parameter_store", "version": ["0.13.0"],
                                    "source": ["cloudposse/ssm-parameter-store/aws"],
                                    "file": "./resources/compute/key_pairs/main.tf", "latest_version": "0.13.0",
                                    "source_url": "https://registry.terraform.io/v1/modules/cloudposse/ssm-parameter-store/aws",
                                    "status": "Updated"}]}, {"path": "./resources/containers/eks_cluster",
                                                             "components": [{"type": "module", "name": "eks",
                                                                             "version": ["20.12.0"], "source": [
                                                                     "terraform-aws-modules/eks/aws"],
                                                                             ...
                                                                             "status": "Outdated"}]},
        {"path": "./resources/containers/eks_addons/apigateway", "components": [
            {"type": "module", "name": "eks_blueprints_addons", "version": ["~> 1.16"],
             "source": ["aws-ia/eks-blueprints-addons/aws"],
             "file": "./resources/containers/eks_addons/apigateway/main.tf", "latest_version": "1.20.0",
             "source_url": "https://registry.terraform.io/v1/modules/aws-ia/eks-blueprints-addons/aws",
             "status": "Outdated"}]}, {"path": "./resources/containers/eks_addons/cloudwatch", "components": [
            {"type": "module", "name": "eks_blueprints_addons", "version": ["~> 1.16"],
             "source": ["aws-ia/eks-blueprints-addons/aws"],
             "file": "./resources/containers/eks_addons/cloudwatch/main.tf", "latest_version": "1.20.0",
             "source_url": "https://registry.terraform.io/v1/modules/aws-ia/eks-blueprints-addons/aws",
             "status": "Outdated"}, {"type": "module", "name": "iam_eks_role", "version": ["5.39.1"], "source": [
                "terraform-aws-modules/iam/aws//modules/iam-role-for-service-accounts-eks"],
                                     ...
                                     "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/iam/aws",
                                     "status": "Outdated"}]},
        {"path": "./resources/containers/eks_addons/open_telemetry", "components": [
            {"type": "module", "name": "eks_blueprints_addons", "version": ["~> 1.16"],
             "source": ["aws-ia/eks-blueprints-addons/aws"],
             "file": "./resources/containers/eks_addons/open_telemetry/main.tf", "latest_version": "1.20.0",
             "source_url": "https://registry.terraform.io/v1/modules/aws-ia/eks-blueprints-addons/aws",
             "status": "Outdated"}]}, {"path": "./resources/containers/eks_addons/karpenter", "components": [
            {"type": "module", "name": "eks-blueprints-addons", "version": ["1.16.2"],
             "source": ["aws-ia/eks-blueprints-addons/aws"],
             "file": "./resources/containers/eks_addons/karpenter/main.tf", "latest_version": "1.20.0",
             "source_url": "https://registry.terraform.io/v1/modules/aws-ia/eks-blueprints-addons/aws",
             "status": "Outdated"}]}, {"path": "./resources/containers/eks_addons/istio", "components": [
            {"type": "module", "name": "eks_blueprints_addons", "version": ["~> 1.16"],
             "source": ["aws-ia/eks-blueprints-addons/aws"],
             "file": "./resources/containers/eks_addons/istio/main.tf", "latest_version": "1.20.0",
             "source_url": "https://registry.terraform.io/v1/modules/aws-ia/eks-blueprints-addons/aws",
             "status": "Outdated"}]}, {"path": "./resources/network/vpc", "components": [
            {"type": "module", "name": "vpc", "version": ["5.8.1"], "source": ["terraform-aws-modules/vpc/aws"],
             "file": "./resources/network/vpc/main.tf", "latest_version": "5.19.0",
             "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/vpc/aws",
             "status": "Outdated"}]}, {"path": "./resources/network/security_groups/alb_main", "components": [
            {"type": "module", "name": "sg", "version": ["5.1.2"],
             "source": ["terraform-aws-modules/security-group/aws"],
             "file": "./resources/network/security_groups/alb_main/main.tf", "latest_version": "5.3.0",
             "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/security-group/aws",
             "status": "Outdated"}]}, {"path": "./resources/network/security_groups/vpce_secretsmanager",
                                       "components": [{"type": "module", "name": "sg", "version": ["5.1.2"],
                                                       "source": ["terraform-aws-modules/security-group/aws"],
                                                       "file": "./resources/network/security_groups/vpce_secretsmanager/main.tf",
                                                       "latest_version": "5.3.0",
                                                       "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/security-group/aws",
                                                       "status": "Outdated"}]},
        {"path": "./resources/network/security_groups/ec2_bastion", "components": [
            {"type": "module", "name": "sg", "version": ["5.1.2"],
             "source": ["terraform-aws-modules/security-group/aws"],
             "file": "./resources/network/security_groups/ec2_bastion/main.tf", "latest_version": "5.3.0",
             "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/security-group/aws",
             "status": "Outdated"}]}, {"path": "./resources/network/vpc_endpoints", "components": [
            {"type": "module", "name": "vpc_endpoints", "version": ["5.8.1"],
             "source": ["terraform-aws-modules/vpc/aws//modules/vpc-endpoints"],
             "file": "./resources/network/vpc_endpoints/main.tf", "latest_version": "5.19.0",
             "source_url": "https://registry.terraform.io/v1/modules/terraform-aws-modules/vpc/aws",
             "status": "Outdated"}]}]}
