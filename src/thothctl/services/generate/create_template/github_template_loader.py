...
class GitHubTemplateLoader:
    ...
    def load_template(self, project_name: str, project_type: str) -> dict:
        ...
        template_url = self.config.get_template_url(
            project_type
        ) or self.DEFAULT_TEMPLATES.get(project_type)
    ...
    def _clone_and_copy_template(
        self, template_url: str, project_name: str, project_type: str
    ) -> dict:
        """
        ...
        try:
            ...
            self.ui.print_success(
                f"✅ Template loaded successfully from {template_url}"
            )
    ...
    def is_template_available(self, project_type: str) -> bool:
        ...
        return (
            self.config.get_template_url(project_type) is not None
            or project_type in self.DEFAULT_TEMPLATES
        )
