...
def get_credentials_with_password(
    space_name: str, credential_type: str = "vcs"
    ...
    try:
        ...
        logger.warning(
            "Failed to decrypt credentials, trying again with a new password"
        )
...
def load_credentials(
    space_name: str, credential_type: str = "vcs", password: Optional[str] = None
) -> Dict[str, Any]:
    """
