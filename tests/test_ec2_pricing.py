...
from thothctl.services.check.project.cost.pricing.providers.ec2_pricing import (
    EC2PricingProvider,
)
...
class TestEC2PricingProvider:
    ...
    def test_calculate_cost_api_unavailable(self, ec2_provider):
        ...
        resource_change = {
            "address": "aws_instance.test",
            "type": "aws_instance",
            "change": {"actions": ["create"], "after": {"instance_type": "t3.small"}},
        }
    ...
    def test_region_to_location_mapping(self, ec2_provider):
        ...
        assert (
            ec2_provider._region_to_location("unknown-region")
            == "US East (N. Virginia)"
        )
