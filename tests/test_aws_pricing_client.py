...
import pytest
from thothctl.services.check.project.cost.pricing.aws_pricing_client import (
    AWSPricingClient,
)
...
class TestAWSPricingClient:
    ...
    @patch(
        "thothctl.services.check.project.cost.pricing.aws_pricing_client.requests.get"
    )
