...
from thothctl.services.check.project.cost.pricing.providers.bedrock_pricing import (
...
class TestBedrockPricingProvider:
    ...
    def test_provisioned_throughput_cost(self, bedrock_provider):
        ...
        assert cost.monthly_cost == pytest.approx(
            2500.0
        )  # High cost for provisioned capacity
